TODO:
supprimer id dans le Create DTO

interfaces pour la cli, pour le framework NestJs
mocks pour pour la cli, pour le framework NestJs
services pour pour la cli, pour le framework NestJs
templates pour les projet NestJs
...
{
"name": "NotContains",
"description": "Vérifie si la chaîne ne contient pas la sous-chaîne spécifiée",
"options": {
"seed": "Sous-chaîne à rechercher"
}
},
...
"domainSpecificValidation": "Active la validation spécifique au domaine",
"ignoreMaxLength": "Ignore la longueur maximale"
}
},
{
"name": "IsFQDN",
"description": "Vérifie si la chaîne est un nom de domaine complet valide",
"options": {
...
{
"name": "Length",
"description": "Vérifie si la longueur de la chaîne est dans la plage spécifiée",
"options": {
...
{
"name": "MinLength",
"description": "Vérifie si la longueur de la chaîne est supérieure ou égale au minimum spécifié",
"options": {
"min": "Longueur minimale"
}
},
{
"name": "MaxLength",
"description": "Vérifie si la longueur de la chaîne est inférieure ou égale au maximum spécifié",
"options": {
"max": "Longueur maximale"
}
},
{
"name": "Matches",
"description": "Vérifie si la chaîne correspond à l'expression régulière",
"options": {
...
{
"name": "IsAlphanumeric",
"description": "Vérifie si la chaîne contient uniquement des lettres et des chiffres",
"options": {
"locale": "Locale pour les règles spécifiques à la langue"
}
},
...
{
"name": "IsAscii",
"description": "Vérifie si la chaîne contient uniquement des caractères ASCII",
"options": {}
},
{
"name": "IsBase64",
...
{
"name": "IsCreditCard",
"description": "Vérifie si la chaîne est un numéro de carte de crédit valide",
"options": {}
},
{
"name": "IsCurrency",
...
{
"name": "IsMobilePhone",
"description": "Vérifie si la chaîne est un numéro de téléphone mobile valide",
"options": {
...
{
"name": "IsPhoneNumber",
"description": "Vérifie si la chaîne est un numéro de téléphone valide",
"options": {
...
{
"name": "IsHexColor",
"description": "Vérifie si la chaîne est une couleur hexadécimale valide",
"options": {}
},
{
"name": "IsRgbColor",
...
{
"name": "IsSemVer",
"description": "Vérifie si la chaîne est une version sémantique valide",
"options": {}
},
{
"name": "IsISRC",
...
{
"name": "Min",
"description": "Vérifie si la valeur est supérieure ou égale au minimum spécifié",
"options": {
"min": "Valeur minimale"
}
},
{
"name": "Max",
"description": "Vérifie si la valeur est inférieure ou égale au maximum spécifié",
"options": {
"max": "Valeur maximale"
}
},
{
"name": "IsDivisibleBy",
"description": "Vérifie si la valeur est divisible par le nombre spécifié",
"options": {
"num": "Diviseur"
}
},
...
{
"name": "ArrayContains",
"description": "Vérifie si le tableau contient tous les éléments spécifiés",
"options": {
...
"description": "Vérifie si le tableau ne contient aucun des éléments spécifiés",
"options": {
...
{
"name": "ArrayMinSize",
"description": "Vérifie si la taille du tableau est supérieure ou égale au minimum spécifié",
"options": {
"min": "Taille minimale"
}
},
{
"name": "ArrayMaxSize",
"description": "Vérifie si la taille du tableau est inférieure ou égale au maximum spécifié",
"options": {
"max": "Taille maximale"
}
},
...
{
"name": "MinDate",
"description": "Vérifie si la date est postérieure ou égale à la date minimale spécifiée",
"options": {
"date": "Date minimale"
}
},
{
"name": "MaxDate",
"description": "Vérifie si la date est antérieure ou égale à la date maximale spécifiée",
"options": {
"date": "Date maximale"
}
}
...
{
"name": "IsInstance",
"description": "Vérifie si la valeur est une instance de la classe spécifiée",
"options": {
...
{
"name": "NotEquals",
"description": "Vérifie si la valeur n'est pas égale à la valeur spécifiée",
"options": {
"comparison": "Valeur de comparaison"
}
},
{
"name": "IsEmpty",
"description": "Vérifie si la valeur est vide (null, undefined, vide)",
"options": {}
},
{
"name": "IsNotEmpty",
...
{
"name": "IsIn",
"description": "Vérifie si la valeur est dans la liste des valeurs autorisées",
"options": {
...
{
"name": "IsNotIn",
"description": "Vérifie si la valeur n'est pas dans la liste des valeurs interdites",
"options": {
...
{
"name": "ValidateIf",
"description": "Valide conditionnellement en fonction d'une condition",
"options": {
...
{
"name": "Trim",
"description": "Supprime les espaces au début et à la fin de la chaîne"
}
]
}
}
