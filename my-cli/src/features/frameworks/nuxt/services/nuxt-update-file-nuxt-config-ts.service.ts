...
export async function nuxtUpdateFileNuxtConfigTsService(
    ...
    try {
        ...
        const currentConfig: INuxtConfigTs =
            (mod && (mod.default ?? mod)) as INuxtConfigTs
...
export function nuxtUpdateContentFileNuxtConfigTs(
    ...
    cfg.app.head.meta = [
        { name: "description", content: "Super app Nuxt 3" },
    ]
    ...
    cfg.css = Array.from(new Set([...(cfg.css ?? []), "~/assets/css/main.css", "~/assets/css/tailwind.css"]))
