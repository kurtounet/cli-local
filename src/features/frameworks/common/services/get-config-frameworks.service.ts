...
import { IFramework, IProjectConfig } from "@features/frameworks/models/framework-commun.model";
...
export function getConfigFrameworks(frameWorks: Array<string>): Array<IFramework> {
